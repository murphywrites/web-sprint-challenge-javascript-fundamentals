...
// In Line 12, the function nestedFunction() is prompted to search for a variable named "internal". First, it looks within itself to find that variable name. Once it is finished searching for the variable within the function, javascript functions have the ability to search for a variable outside of itself. During this second phase of the search, nestedFunction() finds the variable "internal" declared on Line 9 and is able to use this on Line 12.
...
const zooAnimals = [
  ...
  */
  function lowPopulationAnimals(data){
    const lowPopulationAnimals = data.filter((item) => {
  ...
  */
  function USApop(data){
    const totalAnimalPop = data.reduce((accumulator, item) => {
...
/* 🐴🐴🐴 Step 3: Surface Area Method 🐴🐴🐴
  ...
  CuboidMaker.prototype.surfaceArea = function() {
    return 2 * (this.length * this.height + this.width * this.height + this.width * this.length);
  }
...
console.log("test",cube.cubeVolume())
